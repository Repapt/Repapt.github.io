    ...
    return (
      <div className="page">
        <div id="about-text" className="text">
          ...
          <p className="body">escape rooms and video games. Eventually, though, my passions shifted to a slightly</p>
          <p className="body">different form of problem-solving: programming. I've worked with web design, backend</p>
